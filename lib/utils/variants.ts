...
export const AnimationVariants = cva('', {
  variants: {
    type: {
      ...
      slideInLeft: 'ui-animate-slideInFromLeft',
      slideInRight: 'ui-animate-slideInFromRight',
      slideOutLeft: 'ui-animate-slideOutToLeft',
      slideOutRight: 'ui-animate-slideOutToRight',
